...
a persistence unit "grupo15PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "grupo15\pom.xml":
...
artifacts ("grupo15-ejb.jar" and "grupo15-web.war") are already built. You can build
