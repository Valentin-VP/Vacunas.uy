...
public class GestionLaboratorioRWS {
	...
	public Response obtenerLaboratorio(@QueryParam("lab") String lab) {
		if (lab == null) {
			return ResponseBuilder.createResponse(Response.Status.BAD_REQUEST, "No se ha recibido laboratorio");
		}
		try {
	...
	public Response agregarLaboratorio(String lab) {
		if (lab == null) {
			return ResponseBuilder.createResponse(Response.Status.BAD_REQUEST, "No se ha recibido el laboratorio");
		}
		try {
