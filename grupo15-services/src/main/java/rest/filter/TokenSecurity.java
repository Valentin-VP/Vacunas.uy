...
public class TokenSecurity {
	...
	private static String issuer = "vacunas-uy.com";
	...
	public static String generateJwtToken(String id, String tipoUsuario ) throws JoseException {
	    ...
	    claims.setClaim( "tipoUsuario", tipoUsuario );
	...
	public static JwtClaims validateJwtToken( String jwt ) throws InvalidJwtException {
	...
	public static String getIdClaim(JwtClaims jwtClaims) {
		// return the encoded user id
		return jwtClaims.getClaimsMap().get("id").toString();
	}
	
	public static String getTipoUsuarioClaim(JwtClaims jwtClaims) {
		return jwtClaims.getClaimsMap().get("tipoUsuario").toString();
	}
}
