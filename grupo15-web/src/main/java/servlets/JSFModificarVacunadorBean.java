...
@Named("ModificarVacunador")
@SessionScoped
public class JSFModificarVacunadorBean implements Serializable{
	...
	public JSFModificarVacunadorBean() {}
	...
	public void cargaInicial() {
		try {
			...
			WebTarget webTarget = conexion.target(hostname + "/grupo15-services/rest/usuario/vacunador/buscar");
